...
export function ConnectedButton({ onChangeWallet: onWalletChange }: ConnectedButtonProps) {
  ...
  return (
    <div className='relative'>
      ...
      >
        <div className='bg-color-11 rounded-64 relative flex w-23 items-center border-r-0 py-2 pl-4'>
        ...
        <Condition if={!isPending}>
          <div className='border-color-8 bg-color-4 rounded-64 relative -top-[0.5px] -right-[0.25px] h-11 border-[0.25px] px-5 py-[13.5px] hover:brightness-90'>
            <Text
              size='11'
              weight='500'
              lineHeight='16'
